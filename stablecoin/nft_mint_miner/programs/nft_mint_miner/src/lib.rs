...
pub mod nft_mint_miner {
    ...
    pub fn create_single_nft( ctx: Context<CreateNFT>, id: u64, symbol: String, uri: String, price: f32, cant: u64) -> Result<()> {

        msg!("Creating seeds");
        let id_bytes = id.to_le_bytes();
        let seeds = &["mint".as_bytes(),id_bytes.as_ref(),&[ctx.bumps.mint],];
        let name: String = "Bitcoin Standard Hashrate Token Agreement".to_string(); 
